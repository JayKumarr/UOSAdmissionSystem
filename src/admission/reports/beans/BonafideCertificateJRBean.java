...
public class BonafideCertificateJRBean {
    ...
    public BonafideCertificateJRBean(HashMap<String, String> data, int year, boolean isBachalor) {
        this.year = year;
        this.name = (data.get("gender").equals("0") ? "Mr. " : "Ms. ") + TextFormatter.capitalizeEachWord(data.get("name"));
        this.fathersName = (data.get("gender").equals("0") ? "S/o " : "D/o ") + TextFormatter.capitalizeEachWord(data.get("fname"));
        ...
        this.respect = data.get("gender").equals("0") ? "He" : "She";
