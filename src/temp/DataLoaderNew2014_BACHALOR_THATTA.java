...
// */
//public class DataLoaderNew2014_BACHALOR_THATTA {
...
//        Campus        campus       = (Campus) DatabaseManager.getSingleRecord(Campus.class.getName(), 7);
//        Test          test         = (Test) DatabaseManager.getSingleRecord(Test.class.getName(), 8);
...
//        }
//
//        Scanner scan = new Scanner(new FileInputStream("THATTACSV.txt"));
//
