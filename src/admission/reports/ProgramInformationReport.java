        ...
        for (int i = 0; i < beanList.size(); i++) {
            ...
            if(!cposg.isIsBachelor()) {
                posName = (
                        ...
                        ? (cposg.isIsMorning() ? cposg.getProgramName() + " (FIRST YEAR)" : cposg.getProgramName() + " FIRST YEAR") :
...
//                posName = cposg.toString();
            posName = cposg.getProgramName().equals("B.B.A (HONS)") ? cposg.getProgramName() + " (HONS) FIRST YEAR" 
...
//            g2d.drawString("17-01-2014`", 0, y);
            ...
            g2d.drawString("ROLL NO.", x + 470, y);
            ...
            for (int i = 0; i < data.size(); i++) {
                ...
                g2d.drawString("" + objects[5], x + 470, y);
            }
