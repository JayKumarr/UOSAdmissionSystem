    ...
    public static String programFormat(boolean isBachelor, boolean isMorning, String program, String discipline, String partName) {
        ...
        if (!isBachelor) {
            posName = 
                    ...
                    : program.equals("M.B.A (EVENING)") ? "M.B.A - "+ partName
                    : program.equals("M.B.A") ? program + " (" + partName + ")"
                    : 
...
//            }
            posName = program.equals("B.B.A (HONS)") ? program +" "+ partName
                    //: posName.equals("OLD CAMPUS") ? program + " "+ partName +" - OLD CAMPUS"  
                    : program.equals("PHARM-D") ? partName.replace("YEAR","") + " PROF. " + program
                    : program.equals("LL.B") ? program +" ("+ partName +")"
