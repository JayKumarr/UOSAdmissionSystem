...
// */
//public class DataLoaderNew2014_BACHALOR_LARKANA {
...
//        Campus        campus       = (Campus) DatabaseManager.getSingleRecord(Campus.class.getName(), 3);
//        Test          test         = (Test) DatabaseManager.getSingleRecord(Test.class.getName(), 7);
...
//        }
//
//        Scanner scan = new Scanner(new FileInputStream("LARKANACSV.txt"));
//
...
//            byte    OBJECTION  = line[13].equals("Y")
//                                 ? (byte) 1
//                                 : (byte) 0;
//            String  OBJREMARKS = line[14];
//            Integer SSCGROUP   = Integer.parseInt(line[15]);
//            Integer SSCMOBT    = Integer.parseInt(line[16]);
//
////          String SSCLESS = line[37]);
//            Integer  SSCOUTOF  = Integer.parseInt(line[17]);
//            Integer  SSCYEAR   = Integer.parseInt(line[18]);
//            Integer  SSCSEATNO = Integer.parseInt(line[19]);
//            Integer  SSCBOARD  = Integer.parseInt(line[20]);
//            Integer  HSCGROUP  = Integer.parseInt(line[21]);
//            Integer  HSCMOBT   = Integer.parseInt(line[22]);
//            Integer  HSCOUTOF  = Integer.parseInt(line[23]);
//            Integer  HSCYEAR   = Integer.parseInt(line[24]);
//            Integer  HSCSEATNO = Integer.parseInt(line[25]);
//            Integer  HSCBOARD  = Integer.parseInt(line[26]);
//            Integer  TEST      = line[27].equals("N")
//                                 ? null
