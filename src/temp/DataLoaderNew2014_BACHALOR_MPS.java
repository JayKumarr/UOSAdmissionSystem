...
// */
//public class DataLoaderNew2014_BACHALOR_MPS {
...
//        Campus        campus       = (Campus) DatabaseManager.getSingleRecord(Campus.class.getName(), 5);
//        Test          test         = (Test) DatabaseManager.getSingleRecord(Test.class.getName(), 4);
...
//        }
//
//        Scanner scan = new Scanner(new FileInputStream("MIRPURKHASCSV.txt"));
//
...
//            byte    OBJECTION  = line[15].equals("Y")
//                                 ? (byte) 1
//                                 : (byte) 0;
//            String  OBJREMARKS = line[16];
//            Integer SSCGROUP   = Integer.parseInt(line[17]);
//            Integer SSCMOBT    = Integer.parseInt(line[18]);
//
////          String SSCLESS = line[37]);
//            Integer  SSCOUTOF  = Integer.parseInt(line[19]);
//            Integer  SSCYEAR   = Integer.parseInt(line[20]);
//            Integer  SSCSEATNO = Integer.parseInt(line[21]);
//            Integer  SSCBOARD  = Integer.parseInt(line[22]);
//            Integer  HSCGROUP  = Integer.parseInt(line[23]);
//            Integer  HSCMOBT   = Integer.parseInt(line[24]);
//            Integer  HSCOUTOF  = Integer.parseInt(line[25]);
//            Integer  HSCYEAR   = Integer.parseInt(line[26]);
//            Integer  HSCSEATNO = Integer.parseInt(line[27]);
//            Integer  HSCBOARD  = Integer.parseInt(line[28]);
//            Integer  TEST      = Integer.parseInt(line[29]);
...
//                }
//
//                DatabaseManager.addData(new CandidateProgramOfStudy(cpos, c, i - 9, "", null));
//            }
//
