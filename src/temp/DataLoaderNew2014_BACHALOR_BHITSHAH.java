...
// */
//public class DataLoaderNew2014_BACHALOR_BHITSHAH {
...
//        Campus        campus       = (Campus) DatabaseManager.getSingleRecord(Campus.class.getName(), 8);
//        Test          test         = (Test) DatabaseManager.getSingleRecord(Test.class.getName(), 9);
...
//        }
//
//        Scanner scan = new Scanner(new FileInputStream("BHITSHAHCSV.txt"));
//
...
//            String  NAME     = line[5];
//            String  FNAME    = line[6];
//            String  SURNAME  = line[7];
//            Integer DISTRICT = Integer.parseInt(line[8]);
//            String  URBAN    = line[9];
//
...
//            byte    OBJECTION  = line[11].equals("Y")
//                                 ? (byte) 1
//                                 : (byte) 0;
//            String  OBJREMARKS = line[12];
//            Integer SSCGROUP   = Integer.parseInt(line[13]);
//            Integer SSCMOBT    = Integer.parseInt(line[14]);
//
////          String SSCLESS = line[37]);
//            Integer  SSCOUTOF  = Integer.parseInt(line[15]);
//            Integer  SSCYEAR   = Integer.parseInt(line[16]);
//            Integer  SSCSEATNO = Integer.parseInt(line[17]);
//            Integer  SSCBOARD  = Integer.parseInt(line[18]);
//            Integer  HSCGROUP  = Integer.parseInt(line[19]);
//            Integer  HSCMOBT   = Integer.parseInt(line[20]);
//            Integer  HSCOUTOF  = Integer.parseInt(line[21]);
//            Integer  HSCYEAR   = Integer.parseInt(line[22]);
//            Integer  HSCSEATNO = Integer.parseInt(line[23]);
//            Integer  HSCBOARD  = Integer.parseInt(line[24]);
//            Integer  TEST      = line[25].equals("N")
//                                 ? null
...
//
//            AppliedCategory appliedCategory = new AppliedCategory(c, cats[2], "");
//
//            DatabaseManager.addData(appliedCategory);
//
//            CampusProgramOfStudy cpos = (CampusProgramOfStudy) DatabaseManager.getCpos(campus.getCampusId(), 4,
//                                            pt.getProgramTypeId(), morningShift.getShiftId());
//
//            if (cpos == null) {
//                continue;
//            }
//
//            DatabaseManager.addData(new CandidateProgramOfStudy(cpos, c, 1, "", null));
