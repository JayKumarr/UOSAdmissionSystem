 ...
 */
public class CampusDisplayOrderDialog extends javax.swing.JDialog {

    public CampusDisplayOrderDialog(CampusInternalFrame parent) {
    ...
    private void initComponents() {
        ...
        jLabel38.setText("Campus Display Order");
            ...
            @Override public void run() {
                ...
                for (int i = rows - 1; i >= 0; i--) {
                    try{
                        ...
                        Campus campus = (Campus) defaultTableModel.getValueAt(i, 1);
                        campus.setDisplayOrder(order);
                        DatabaseManager.updateData(campus);
                    }catch(HibernateException he){
                        System.out.println(he);
                    }
                }
                updateButton.setEnabled(true);
                admission.utils.MessageBox.info(CampusDisplayOrderDialog.this, "Display oreder set successfully");
            }
        }.start();
