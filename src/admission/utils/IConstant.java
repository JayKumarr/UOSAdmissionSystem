...
public interface IConstant {
    ...
    public static final Float TOTAL_MARKS = 100.0F;
...
//    public static final String EVENING = "Evening";
    ...
    public static final String KARACHI_QUOTA = "KARACHI"; // KARACHI QUOTA
    public static final String SHUHDA_QUOTA = "SHUHDA"; // SHUDHA QUOTA
    ...
    public interface CategoryCodes {
        ...
        public static final int KHI_QUOTA = 22;  // KARACHI 
        public static final int SHUHDA_QUOTA = 23;  // SHUHDA 
    }
